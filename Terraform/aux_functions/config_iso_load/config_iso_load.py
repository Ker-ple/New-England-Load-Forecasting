...
Example JSON output:
{
    ...
    "config": {
        "repeat": "True",
        "seconds_delta": "86400",
        "state_machine_arn": "arn:aws:states:us-east-1:485809471371:stateMachine:ISO-LOAD"
    }
}
"""
...
def make_tables():
    ...
    DDL = """CREATE TABLE IF NOT EXISTS "grid_load" (
            "load_id" INT NOT NULL GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
